            ...
            try:
                ...
                if data:
                    ...
                    if not EXTREMITY:
                        if frame["action"] == "key_establishment":
                            ...
                            if dest == 'aller':  # cas d'un noeud intermédiaire et de clef aller
                                ...
                                extremityHandler = ExtremityHandler(self)
                    ...
                    # EXTREMITY
                        ...
                        if not isSetUp and frame["action"] == "key_establishment":
                            ...
                            if len(receiving_keys) == nb_keys:
                                ...
                                print('\n', receiving_keys)
                                print(
                                    "je suis une extrémité de la connexion (mais je ne suis pas implémenté pour le moment)\n")
                                print("maintenant il faut continuer le programme monsieur svp")

                        elif isSetUp:
                            extremityHandler.handle_message(message)
